...
追記（2026-09-06 12:21）: Sandbox構築後に見つかったアプリ配布物のPDF部品不足も修正し、公開Windows版v1.0.4-r2の初回導入・PDF描画を確認した。[最新の配布検証](DISTRIBUTION_VERIFICATION.md)。以下はWindows修復と、その後の切り分けの履歴。
